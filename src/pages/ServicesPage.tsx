    ...
    <div className="min-h-screen py-20 px-4 sm:px-6 lg:px-8 bg-transparent dot-pattern">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="relative text-center mb-16 animate-in fade-in slide-in-from-top-4 duration-700">
          ...
          <div className="absolute top-0 right-0 hidden md:block">
            <form onSubmit={handlePropostaSubmit} className="flex flex-col items-start">
              <label htmlFor="proposta" className="text-zinc-700 dark:text-neutral-300 text-sm font-medium mb-1">Proposta:</label>
              <div className="relative">
                <input
                  ...
                  className="bg-green-500 text-zinc-900 dark:text-white placeholder:text-green-100 font-medium px-4 py-2 pr-10 rounded-lg outline-none focus:ring-2 focus:ring-green-400 border border-green-400 w-56 shadow-lg shadow-green-500/20"
                />
                <button type="submit" className="absolute right-3 top-1/2 -translate-y-1/2 text-zinc-900 dark:text-white hover:text-green-200">
                  <Search size={16} />
                </button>
              </div>
            </form>
          ...
          <h1 className="text-5xl font-black text-zinc-900 dark:text-white mt-6 mb-6 tracking-tight">Nossos Serviços</h1>
          ...
          <div className="md:hidden mt-8 max-w-xs mx-auto">
            <form onSubmit={handlePropostaSubmit} className="flex flex-col items-center">
              <label htmlFor="proposta-mobile" className="text-zinc-700 dark:text-neutral-300 text-sm font-medium mb-2">Proposta do Cliente</label>
              <div className="relative w-full">
                <input
                  ...
                  value={propostaCode}
                  onChange={(e) => setPropostaCode(e.target.value)}
                  className="bg-green-500 text-zinc-900 dark:text-white placeholder:text-green-100 font-medium px-4 py-3 pr-10 rounded-xl outline-none focus:ring-2 focus:ring-green-400 border border-green-400 w-full shadow-lg shadow-green-500/20 text-center"
                />
                <button type="submit" className="absolute right-4 top-1/2 -translate-y-1/2 text-zinc-900 dark:text-white hover:text-green-200">
                  <Search size={18} />
                </button>
              </div>
            </form>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          {/* Service 1: Sites */}
          <div className="bg-white dark:bg-[#121212] rounded-3xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-300 border border-black/5 dark:border-white/5 group">
            <div className="bg-gradient-to-br from-[#1b3d22]/50 to-[#121212]/50 p-8 text-zinc-900 dark:text-white relative overflow-hidden border-b border-black/5 dark:border-white/5">
            ...
            <div className="p-8">
              <p className="text-zinc-600 dark:text-neutral-400 mb-6 leading-relaxed">
              ...
              <ul className="space-y-3 mb-8">
                {['Design responsivo e mobile-first', 'Otimizado técnica e estruturalmente para SEO', 'Foco total em performance (Lighthouse 90+)', 'Painel administrativo integrado para gestão'].map(item => (
                  <li key={item} className="flex items-start gap-3">
                    ...
                    <span className="text-zinc-700 dark:text-neutral-300 font-medium">{item}</span>
                  </li>
                ))}
              </ul>
          ...
          {/* Service 2: Branding */}
          <div className="bg-white dark:bg-[#121212] rounded-3xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-300 border border-black/5 dark:border-white/5 group">
            <div className="bg-gradient-to-br from-white dark:from-[#121212] to-neutral-900/40 p-8 text-zinc-900 dark:text-white relative overflow-hidden border-b border-black/5 dark:border-white/5">
          ...
          {/* Service 3: Tráfego */}
          <div className="bg-white dark:bg-[#121212] rounded-3xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-300 border border-black/5 dark:border-white/5 group">
            <div className="bg-gradient-to-br from-[#1b3d22]/40 to-[#121212]/50 p-8 text-zinc-900 dark:text-white relative overflow-hidden border-b border-black/5 dark:border-white/5">
          ...
          {/* Service 4: SEO */}
          <div className="bg-white dark:bg-[#121212] rounded-3xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-300 border border-black/5 dark:border-white/5 group">
            <div className="bg-gradient-to-br from-[#3d341b]/30 to-[#121212]/50 p-8 text-zinc-900 dark:text-white relative overflow-hidden border-b border-black/5 dark:border-white/5">
        ...
        <div className="bg-gradient-to-r from-green-950/40 to-neutral-900/60 rounded-3xl p-12 text-center text-zinc-900 dark:text-white border border-black/5 dark:border-white/5 relative overflow-hidden group shadow-2xl">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,_rgba(46,125,50,0.1),_transparent_60%)]" />
          <h2 className="text-4xl font-black mb-4 relative z-10 tracking-tight text-zinc-900 dark:text-white">Precisa de um Projeto Personalizado?</h2>
          <p className="text-xl text-zinc-700 dark:text-neutral-300 mb-8 max-w-2xl mx-auto relative z-10 leading-relaxed font-medium">
